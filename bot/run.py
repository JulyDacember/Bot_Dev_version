...
async def main():
	...
	await bot.set_my_commands([
		...
		BotCommand(command='add_requisites', description='Указать реквизиты'),
		BotCommand(command='my_requisites', description='Мои реквизиты'),
		BotCommand(command='create_refund', description='Создать возврат'),
		BotCommand(command='my_refunds', description='Мои возвраты')
	])
